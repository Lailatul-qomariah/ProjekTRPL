       ...
       <div class="col-md-4">
          <div class="property-wrap">
            ...
            <div class="text">
              ...
              <p class="price mb-3"><span class="orig-price">by Designer : {{ $pesanan->KetVerifikasi }}</span></p>
              <!-- <h3 class="mb-0">Keterangan Verifikasi : {{ $pesanan->Kete }}</h3> -->
              <p class="price mb-3"><span class="orig-price">Pesanan Telah Diselesaikan</p>
