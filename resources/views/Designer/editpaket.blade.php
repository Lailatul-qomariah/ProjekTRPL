...
<section class="ftco-section contact-section">
  ...
  <div class="col-md-6 align-items-stretch d-flex">
    <form method="POST" action="/paketdesign/{{ $paketdesign->IdPaket}}" class="bg-light p-5 contact-form" enctype="multipart/form-data">
      @method('patch')
      @csrf
      <input type="text" name="Designer" value="{{auth()->user()->id}}" hidden>
      <div class="form-group{{$errors->has('NamaPaket') ? 'has-error' : ''}}">
        <label for="NamaPaket"> Masukkan Nama Paket Design Interior Anda :</label>
        <input type="text" class="form-control" placeholder="Contoh : Paket Hemat" name="NamaPaket" value="{{ $paketdesign->NamaPaket}}">
      ...
      <div class="form-group {{$errors->has('Kategori') ? 'has-error' : ''}}">
        ...
        <input type="text" class="form-control" placeholder="Contoh : Minimalis " name="Kategori" value="{{ $paketdesign->Kategori}}">
      ...
      <div class="form-group {{$errors->has('JenisRuang') ? 'has-error' : ''}}">
        ...
        <input type="text" class="form-control" placeholder="Contoh : ruang tamu" name="JenisRuang" value="{{ $paketdesign->JenisRuang}}">
      ...
      <div class="form-group {{$errors->has('Luas') ? 'has-error' : ''}}">
        ...
        <input type="text" class="form-control" placeholder="Contoh : 20" name="Luas" value="{{ $paketdesign->Luas}}">
        @if($errors->has('Luas'))
        <button data-toggle="modal" data-target="#myModal3" style="display:none;" class="but"></button>
          <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
              <div class="modal-dialog">
      ...
      <div class="form-group {{$errors->has('TinggiRuang') ? 'has-error' : ''}}">
        ...
        <input type="text" name="TinggiRuang" class="form-control" placeholder="Contoh : 7" value="{{ $paketdesign->TinggiRuang}}" >
      ...
      <div class="form-group {{$errors->has('RangeHarga') ? 'has-error' : ''}}">
        ...
        <input type="text" name="RangeHarga" class="form-control" placeholder="Contoh : 1000000" value="{{ $paketdesign->RangeHarga}}">
      ...
      <div class="form-group{{$errors->has('WaktuPembuatan') ? 'has-error' : ''}}">
        ...
        value="{{ $paketdesign->WaktuPembuatan}}">
      ...
      <div class="form-group {{$errors->has('Keterangan') ? 'has-error' : ''}}">
        ...
        <textarea name="Keterangan" cols="30" rows="7" class="form-control" placeholder="Keterangan">{{ $paketdesign->Keterangan}}</textarea>
