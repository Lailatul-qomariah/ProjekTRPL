          ...
          <div class="property-wrap">
            ...
            <div class="text">
              ...
              <ul class="property_list">
                ...
                @if($pesanan->StatusPesanan == 'Batal')
                <p class="price mb-3"><span class="orig-price text-danger">Pesanan ini Dibatalkan Oleh Customers</span></p>
                @endif
                @if($pesanan->StatusPesanan == 'Selesai')
                <p class="price mb-3"><span class="orig-price">Pesanan ini Telah Diselesaikan</span></p>
                @endif
