  ...
  <div class="col-md-6 align-items-stretch d-flex">
    <form method="POST" action="/designrumah/{{ $m_DataPaketDesign->idPaketRumah}}" class="bg-light p-5 contact-form" enctype="multipart/form-data">
      ...
      <div class="form-group{{$errors->has('GamabarRumah') ? 'has-error' : ''}}">
        Gambar lama  : <img src="{{ asset ('assets/images/'. $m_DataPaketDesign->GamabarRumah )}} " width="100" height="100">
        <br><label for="GamabarRumah"> Masukkan Gambar Rumah :</label> <br>
        <input type="file" name="GamabarRumah" class="form-control" value="{{$m_DataPaketDesign->GamabarRumah}}" >
