	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="{{route('designrumahUser')}}" class="nav-link">Design Rumah</a></li>
	          <li class="nav-item"><a href="{{route('paketdesign2')}}" class="nav-link">Design Interior</a></li>
            @guest
            ...
            <div class="row no-gutters slider-text justify-content-center align-items-center">
              <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
                <div class="text text-center w-100">
                  ...
                  <p><form method="GET" action="/paketdesignUser">
                    <input name="cari" class="form-control mr-sm-1" type="search" placeholder="Cari berdasarkan kategori" aria-label="Search">
